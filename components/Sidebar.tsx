...
export default function Sidebar() {
    ...
    const navs = [
        ...
        {id:1, label:'Courses Taken', icon:<FaListCheck/>, ref:'/dashboard/manage-courses'},
        {id:2, label:'Theory Answers', icon:<RiQuestionAnswerLine/>, ref:'/dashboard/answers'},
        {id:3, label:'View Results', icon:<MdScoreboard/>, ref:'/dashboard/view-results'},
    ];
